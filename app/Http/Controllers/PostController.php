...
//كريت مع ستور
    ...
    {                                     // الركوست بتبقى شايله الداتا بتاعتي الي جايه من على الفورم
        ...
        // $data = $request->all();// ممكن اعمل كده وابعتها داتا كمتغير في كريت
        // بس انا مش هعمل كده عشان خاطر الفورين كي لازم احطه في بايدي بما انه بيبقى مش موجود فالريكوست
        Post::create(
            [
                'title'=>$request->title,
                'post_description'=>$request->post_description,
                'user_id'=>Auth::id()  // عملت امبروت ليها. ده معناه ان اليوزر الي عمل خلاص *لوج ان* هات الاي دي بتاعه من الداتا بيز
                //لازم اباصي ديه عشان في التايبل هناك بعد محطيت الفورين كي لازم اباصيله الفورين كي الي هو هنا يعني اليوزر اي دي لجدول البوست
            ]
        );                  // create is function
                            // insert query
